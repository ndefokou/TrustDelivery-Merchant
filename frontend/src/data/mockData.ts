...
export const mockDeliveries: Delivery[] = [
  {
    ...
    delivery_address_text: 'Essos Hôpital',
    distance_km: 5.5,
    delivery_cost: 1500,
  ...
  },
  {
    ...
    delivery_address_text: 'Mendong Marché',
    distance_km: 9.2,
    delivery_cost: 2000,
    status: 'assigned',
  ...
  },
  {
    ...
    delivery_address_text: 'Akwa Boulevard de la Liberté',
    distance_km: 4.1,
    delivery_cost: 1500,
    status: 'delivered',
    payment_method: 'orange_money',
  ...
  },
  {
    ...
    delivery_address_text: 'Bonapriso Marché',
    distance_km: 2.6,
    delivery_cost: 1000,
    status: 'delivered',
    payment_method: 'mtn_momo',
  ...
  },
  {
    ...
    delivery_address_id: 'addr-6',
    delivery_address_text: 'Logbessou Université',
    distance_km: 11.8,
    delivery_cost: 3000,
    status: 'failed',
    payment_method: 'mtn_momo',
